...
var title = document.getElementById("title").innerHTML; //docTitle
document.getElementById("docTitle").innerHTML = "Document title is " + title;
document.getElementById("docUpdate").innerHTML = "This document was last updated on " + document.lastModified; //docUpdate
